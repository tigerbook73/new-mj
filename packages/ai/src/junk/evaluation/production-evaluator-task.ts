import { evaluateProductionFixture, type ProductionEvaluatorOptions } from "./production-evaluator.ts";
...
export type JunkProductionEvaluationTaskInput = CalibrationEvaluationTaskInput<JunkProductionFixtureInput>;
