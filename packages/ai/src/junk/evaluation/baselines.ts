import discardProduction from "./fixtures/baselines/discard-001.production-weighted.v1.baseline.json" with { type: "json" };
...
import snapshotProduction from "./fixtures/baselines/discard-snapshot-001.production-weighted.v1.baseline.json" with { type: "json" };
