...
血战 RuleSet 已完成换三张/定缺、playing 回合、缺门约束、碰/杠/胡声明窗口、头跳/一炮多响、多赢家离场、杠分账本、抢杠胡、呼叫转移、三家胡、牌墙耗尽、查花猪/退税/查大叫和 `mustHuOnLastFour`。已注册进 `engine.ts`，PlayerView 与事件回放保持一致，public 事件不泄漏 TileId。
