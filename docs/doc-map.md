...
| 当前专题、风险、Backlog、完成摘要 | `process/plan.md`                  | 过程性，持续清理           |
...
- 专题推演只留在 `plan.md`，或临时一页 `process/<topic>.md`。完成后只保留一行完成摘要，耐久结论分流，临时文档删除。
