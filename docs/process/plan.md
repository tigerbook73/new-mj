...
> 本文件只保留项目基线、已完成能力、当前阶段与下一步。复杂阶段的范围、目标和待办另立 `process/<phase 简称>.md`，由本文件当前工作区链接过去（见 `doc-map.md` §5）。过程细节在阶段收尾时清理，耐久结论进入 contracts 或 architecture。
