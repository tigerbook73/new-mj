...
- Top-N 2-ply 已完成 32 手牌/96 case A/B：1-ply/Top-1/Top-2/Top-3 相对全量 2-ply 一致率为 78.1%/78.1%/90.6%/93.8%，存在明显决策漂移，拒绝直接接入默认评分。
...
下一步第一个具体动作：实现分级 2-ply A/B，在候选接近或高风险局面补跑更多候选；core batch API 同步提回 Claude Project。
