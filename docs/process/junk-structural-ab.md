...
独立顶层 seed `20260817` 的扩大验证使用 50 seeds / 100 场换位 match，仍无失败或步数
上限；structural P50/P95/max 为 `0.260/26.590/46.935ms`，weighted 为
`0.250/22.894/337.735ms`。structural/weighted 总分 `-181/181`、胜场 `28/61`、11 平，
50 个配对 seed 中 structural 净正 14、净负 35、1 平。structural-even/odd 分别为 `-90/-91`，
说明较大独立样本中的质量落后不是先前 split 不对称造成；性能门槛稳定通过，质量门槛明确
失败，当前版本不得切生产。
