...
Top-N 2-ply 已加入仅诊断的候选预算 benchmark，未接入默认策略。固定 bridge fixture 的
20 次热态初测为 N=1/2/3/全部约 33.5/42.7/51.3/137.7ms，四种预算的最佳弃牌均为
`3m`。这证明了潜在性能收益，但单 fixture 不能证明决策质量，当前结论为**暂不接纳，
继续多 fixture/随机 A/B**。
