...
3 轮共 96 个 case 的 A/B 为：N=1/2/3 的最佳弃牌一致率 78.125%/90.625%/93.75%，
平均 2-ply 分差 0.4541/0.1038/0.0697，耗时约 8.31/16.28/24.23ms/case；全量约
91.98ms/case。性能收益明确，但决策漂移也明确，当前结论为**拒绝直接接入默认评分**，
转入分级 2-ply 评估。
